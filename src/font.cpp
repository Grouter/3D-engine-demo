...
internal f32 get_string_width_in_units(const Font &font, const char *text, f32 scale_factor = 1.0f) {
...
internal f32 get_char_width_in_units(const Font &font, u8 c, f32 scale_factor = 1.0f) {
...
// @Speed
internal GlyphRenderData get_glyph(const Font &font, char c) {
